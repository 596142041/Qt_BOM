...
void MainWindow::on_pushButton_open_cmp_clicked()
{
    ...
    foreach (const QString& filename, same_list)//遍历
    {
        ...
        Read_cell_A.clear ();
        Read_cell_B.clear ();
        //qDebug()<<"Read_New_BOM->cellAt(11,4):"<<Read_New_BOM->cellAt(row_A,Excel_Column_INDEX::Point_Column)->value().toString();
        //qDebug()<<"Read_Old_BOM->cellAt(11,4):"<<Read_Old_BOM->cellAt(row_B,Excel_Column_INDEX::Point_Column)->value().toString();
        ...
        Factory_Cell.remove (Factory_Cell.size ()-1,1);//移除末尾人为添加的逗号
